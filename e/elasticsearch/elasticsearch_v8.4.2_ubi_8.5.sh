...
WORKDIR=`pwd`
ELASTICSEARCH_VERSION=${1:-v8.4.2}
...
# apply patch
wget https://raw.githubusercontent.com/ppc64le/build-scripts/master/e/elasticsearch/elasticsearch_v8.4.2.patch
git apply elasticsearch_v8.4.2.patch
...
sed -i 's/18.0.2.*/18.0.2.1+1/' build-tools-internal/version.properties
